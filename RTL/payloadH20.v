...
input [50:0] payloadIn;   
output [127:0] payloadStr;

wire [127:0] payloadStr;

cnvTHC cnvTHC_C(.nybleIn ({1'b0, payloadIn[50:48]}), .charOut (payloadStr[127:120]));
assign payloadStr[119:112] = 8'h20;
cnvTHC cnvTHC_B(.nybleIn (payloadIn[47:44]), .charOut (payloadStr[111:104]));
cnvTHC cnvTHC_A(.nybleIn (payloadIn[43:40]), .charOut (payloadStr[103:96]));
cnvTHC cnvTHC_9(.nybleIn (payloadIn[39:36]), .charOut (payloadStr[95:88]));
cnvTHC cnvTHC_8(.nybleIn (payloadIn[35:32]), .charOut (payloadStr[87:80]));
assign payloadStr[79:72] = 8'h20;
cnvTHC cnvTHC_7(.nybleIn (payloadIn[31:28]), .charOut (payloadStr[71:64]));
cnvTHC cnvTHC_6(.nybleIn (payloadIn[27:24]), .charOut (payloadStr[63:56]));
cnvTHC cnvTHC_5(.nybleIn (payloadIn[23:20]), .charOut (payloadStr[55:48]));
cnvTHC cnvTHC_4(.nybleIn (payloadIn[19:16]), .charOut (payloadStr[47:40]));
assign payloadStr[39:32] = 8'h20;
cnvTHC cnvTHC_3(.nybleIn (payloadIn[15:12]), .charOut (payloadStr[31:24]));
cnvTHC cnvTHC_2(.nybleIn (payloadIn[11:8] ), .charOut (payloadStr[23:16]));
cnvTHC cnvTHC_1(.nybleIn (payloadIn[7:4]  ), .charOut (payloadStr[15:8] ));
