...
bindec3 shftadd0(.bin_in ({1'b0, binIn[9:7]}), .dec_out(shftadd0_out));

bindec3 shftadd1(.bin_in ({shftadd0_out[2:0], binIn[6]}), .dec_out(shftadd1_out));
    
bindec3 shftadd2(.bin_in ({shftadd1_out[2:0], binIn[5]}), .dec_out(shftadd2_out));

bindec3 shftadd31(.bin_in ({1'b0, shftadd0_out[3], shftadd1_out[3], shftadd2_out[3]}), .dec_out(shftadd31_out));
bindec3 shftadd30(.bin_in ({shftadd2_out[2:0], binIn[4]}), .dec_out(shftadd30_out));

bindec3 shftadd41(.bin_in ({shftadd31_out[2:0], shftadd30_out[3]}), .dec_out(shftadd41_out));
bindec3 shftadd40(.bin_in ({shftadd30_out[2:0], binIn[3]}), .dec_out(shftadd40_out));

bindec3 shftadd51(.bin_in ({shftadd41_out[2:0], shftadd40_out[3]}), .dec_out(shftadd51_out));
bindec3 shftadd50(.bin_in ({shftadd40_out[2:0], binIn[2]}), .dec_out(shftadd50_out));
...
bindec3 shftadd60(.bin_in ({shftadd50_out[2:0], binIn[1]}), .dec_out(shftadd60_out));
                     
assign {decDigit2, decDigit1, decDigit0} = {shftadd62_out[2:0], shftadd61_out[3:0], shftadd60_out[3:0], binIn[0]};
